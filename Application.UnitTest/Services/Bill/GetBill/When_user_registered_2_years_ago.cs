...
public class When_user_registered_2_years_ago : Given, IAsyncLifetime
{
    public async Task InitializeAsync()
    {
        ...
        var registirationDate = DateTime.Today.AddYears(-2);
    ...
    {
        ResponseDto.Product.DiscountedPrice.Should().Be(185);
    }
}