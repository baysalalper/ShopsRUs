...
public class When_user_has_no_percentage_based_discount_and_price_less_than_100 : Given, IAsyncLifetime
{
    ...
    {
        ResponseDto.Product.DiscountedPrice.Should().Be(ProductPrice);
    }
}